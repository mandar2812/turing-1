...
case class ProgramBuilder private(private val initialStateId: StateId, private val states: Map[StateId, State]){
	...
	/**
	 * A string representation of this builder, similar to [[com.github.skozlov.turing.Program.toString]]
	 */
...
object ProgramBuilder{
	...
	/**
	 * A specification of the [[com.github.skozlov.turing.Command]]
	...
	case class Command(cellNewState: Option[CellState] = None, movement: Option[Direction] = None, nextStateId: StateId){
		/**
		 * A string representation of this command, similar to [[com.github.skozlov.turing.Command.toString]]
		 */
		override lazy val toString: String = {
		 ...
		 * @example {{{
		 * import com.github.skozlov.turing.build.Dsl.commandFromNextStateId
		 * val command = "q1".c
		 * }}}
		 */
		val c = this
	...
	object Command{
		...
		trait Incomplete{
			 ...
			 * [[com.github.skozlov.turing.Direction.Direction]] or [[com.github.skozlov.turing.CellState.CellState]]
			 * to [[Incomplete]].
			 * See [[com.github.skozlov.turing.build.ProgramBuilder.Command.Incomplete.Moving]]
			 * and [[com.github.skozlov.turing.build.ProgramBuilder.Command.Incomplete.Modifying]] for examples.
			 */
			 ...
			 * @example
			 * {{{
			 * import com.github.skozlov.turing.build.Dsl.movingCommandFromMovement
		...
		object Incomplete{
			 ...
			 * @example {{{
			 * import com.github.skozlov.turing.build.Dsl.modifyingCommandFromCellNewState
			 * import com.github.skozlov.turing.CellState._
			 * val command = Zero.c
			 * }}}
			 */
